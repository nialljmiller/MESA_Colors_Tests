...
SOURCE_STELLAR_ATM = os.path.join(
    _mesa, "data/colors_data/stellar_models/tlusty_mergedbin"
)
...
_DEFAULT_STELLAR_ATM = "data/colors_data/stellar_models/tlusty_mergedbin/"
...
def test01_input_mesa_dir_relative():
    return _run_test(
        ...
        "data/colors_data/stellar_models/tlusty_mergedbin/",
...
def test02_input_cwd_dotslash():
    ...
    copy_data(SOURCE_STELLAR_ATM, f"{stage}/stellar_models/tlusty_mergedbin")
    copy_data(SOURCE_VEGA_SED, f"{stage}/stellar_models/vega_flam.csv")
    return _run_test(
        "INPUT: CWD-relative (./)",
        f"{stage}/filters/Generic/Johnson",
        f"{stage}/stellar_models/tlusty_mergedbin",
...
def test04_input_absolute():
    ...
    copy_data(SOURCE_STELLAR_ATM, os.path.join(stage, "stellar_models/tlusty_mergedbin"))
    copy_data(SOURCE_VEGA_SED, os.path.join(stage, "stellar_models/vega_flam.csv"))
    return _run_test(
        "INPUT: Absolute path",
        os.path.join(stage, "filters/Generic/Johnson"),
        os.path.join(stage, "stellar_models/tlusty_mergedbin"),
