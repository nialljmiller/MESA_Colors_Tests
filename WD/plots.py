...
def plot_cmd(data, colors, output_dir=OUTPUT_DIR):
    ...
    # Save both PNG and PDF (PDF for paper figures)
    outfile_png = os.path.join(output_dir, 'wd_cmd.png')
    outfile_pdf = os.path.join(output_dir, 'wd_cmd.pdf')
    fig.savefig(outfile_png, dpi=200, bbox_inches='tight')
    fig.savefig(outfile_pdf, bbox_inches='tight')
    print(f"Saved: {outfile_png}, {outfile_pdf}")
    plt.close(fig)
...
def plot_lightcurves(data, output_dir=OUTPUT_DIR):
    ...
    os.makedirs(output_dir, exist_ok=True)
    outfile_png = os.path.join(output_dir, 'wd_lightcurves.png')
    outfile_pdf = os.path.join(output_dir, 'wd_lightcurves.pdf')
    fig.savefig(outfile_png, dpi=200, bbox_inches='tight')
    fig.savefig(outfile_pdf, bbox_inches='tight')
    print(f"Saved: {outfile_png}, {outfile_pdf}")
    plt.close(fig)
...
def plot_color_evolution(data, colors, output_dir=OUTPUT_DIR):
    ...
    os.makedirs(output_dir, exist_ok=True)
    outfile_png = os.path.join(output_dir, 'wd_color_evolution.png')
    outfile_pdf = os.path.join(output_dir, 'wd_color_evolution.pdf')
    fig.savefig(outfile_png, dpi=200, bbox_inches='tight')
    fig.savefig(outfile_pdf, bbox_inches='tight')
    print(f"Saved: {outfile_png}, {outfile_pdf}")
    plt.close(fig)
...
def plot_sed_evolution(sed_dir=SED_DIR, output_dir=OUTPUT_DIR):
    ...
    os.makedirs(output_dir, exist_ok=True)
    outfile_png = os.path.join(output_dir, 'wd_sed_evolution.png')
    outfile_pdf = os.path.join(output_dir, 'wd_sed_evolution.pdf')
    fig.savefig(outfile_png, dpi=200, bbox_inches='tight')
    fig.savefig(outfile_pdf, bbox_inches='tight')
    print(f"Saved: {outfile_png}, {outfile_pdf}")
    plt.close(fig)
...
def plot_hr_diagram(data, output_dir=OUTPUT_DIR):
    ...
    os.makedirs(output_dir, exist_ok=True)
    outfile_png = os.path.join(output_dir, 'wd_hr_diagram.png')
    outfile_pdf = os.path.join(output_dir, 'wd_hr_diagram.pdf')
    fig.savefig(outfile_png, dpi=200, bbox_inches='tight')
    fig.savefig(outfile_pdf, bbox_inches='tight')
    print(f"Saved: {outfile_png}, {outfile_pdf}")
    plt.close(fig)
